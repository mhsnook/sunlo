-- Seed data for scenetest team 1 (HIN/KAN/BEN).
--
-- Mirrors the resource shape of team 2 (see seed-team2.sql), using:
--   lang_full    = Hindi (hin): rich corpus, learner has full deck with reviews
--   lang_partial = Kannada (kan): medium corpus, used for CRUD flows
--   lang_empty   = Bangla (ben): no learner deck, for "create new deck" flows
--
-- Additional team-1 data in: seed-z-comments.sql, seed-z-playlists.sql, seed-v018-extras.sql
--
-- Actor UIDs (parsed by scripts/dump-new-seeds.ts):
-- @uid learner   cf1f69ce-10fa-4059-8fd4-3c6dcef9ba18
-- @uid friend    7ad846a9-d55b-4035-8be2-dbcc70074f74
-- @uid learner2  a2dfa256-ef7b-41b0-b05a-d97afab8dd21
-- @uid learner3  a32f65e7-a496-4afc-abd3-798d8e6d9ec5
-- @uid new-user  d4e5f6a7-b8c9-4d0e-a1f2-b3c4d5e6f7a8
--
set
