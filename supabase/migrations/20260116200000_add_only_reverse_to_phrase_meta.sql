-- Migration: Add only_reverse to phrase_meta view
-- This field was added to the phrase table but not included in the view
-- Drop views in dependency order
drop view if exists public.feed_activities;

drop view if exists public.phrase_meta;

-- Recreate phrase_meta view with only_reverse field
