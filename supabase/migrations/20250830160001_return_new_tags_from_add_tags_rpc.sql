...
create or replace function "public"."add_tags_to_phrase" ("p_phrase_id" "uuid", "p_lang" character varying, "p_tags" "text" []) returns setof "public"."tag" language "plpgsql" as $$
DECLARE
    tag_name text;
    v_tag_id uuid;
