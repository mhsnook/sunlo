...
alter table "public"."user_client_event" add constraint "user_client_event_pkey" PRIMARY KEY using index "user_client_event_pkey";
...
grant select on table "public"."user_client_event" to "anon";

grant trigger on table "public"."user_client_event" to "anon";

grant truncate on table "public"."user_client_event" to "anon";

grant update on table "public"."user_client_event" to "anon";
...
grant select on table "public"."user_client_event" to "authenticated";

grant trigger on table "public"."user_client_event" to "authenticated";

grant truncate on table "public"."user_client_event" to "authenticated";

grant update on table "public"."user_client_event" to "authenticated";
...
grant select on table "public"."user_client_event" to "service_role";

grant trigger on table "public"."user_client_event" to "service_role";

grant truncate on table "public"."user_client_event" to "service_role";

grant update on table "public"."user_client_event" to "service_role";

create policy "Enable insert for any user"
