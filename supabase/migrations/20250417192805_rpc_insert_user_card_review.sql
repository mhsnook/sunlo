create or replace function public.insert_user_card_review (user_card_id uuid, score integer, desired_retention numeric default 0.9) returns timestamp with time zone language plv8 as $$
