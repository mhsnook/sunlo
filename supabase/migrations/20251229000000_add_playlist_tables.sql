...
create policy "Enable update for users based on uid" on "public"."phrase_playlist" as permissive
for update
...
create policy "Enable update for users based on uid" on "public"."playlist_phrase_link" as permissive
for update
	to authenticated using (
		(
			(
