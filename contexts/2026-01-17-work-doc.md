...
- [x] (c2, d2) Feature: Friends feed and Popular feed polymorphic with filters
- [x] (c1, d1) Move add-phrases route to `learn/$lang/phrases/new`
- [x] (c2, d2) Feature: Playlists image option
- [x] (c1, d1) Feature: "You completed your review" nicer screen
- [x] (c2, d2) Chore: Replace the friend request / accept / cancel logic with a before hook
...
- Avatar Buckets: Storage policy for avatars currently allows any authenticated user to upload to any path within the 'avatars' bucket. To properly secure this, the client code would need to be updated to use user-prefixed paths (e.g., {user_id}/avatar.jpg).
