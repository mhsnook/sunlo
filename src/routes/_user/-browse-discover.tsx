	...
	return (
		<span
			className={cn(
				...
				added ? 'hue-success text-con-mid chroma-high' : 'text-con-mhigh'
			)}
		>
			{added ? (
				<>
...
export function SetTile({
	...
	return (
		<Link
			...
			className="bg-card/50 hover:border-con-mlow hover:border-chroma-high block rounded border p-4 transition-colors"
	...
	return (
		...
		>
			<button
				...
				onClick={() => setOpen((o) => !o)}
				aria-expanded={open}
				className="hover:border-con-mlow hover:border-chroma-high flex w-full flex-col gap-1 rounded p-4 text-start transition-colors"
			>
