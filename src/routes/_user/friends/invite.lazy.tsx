	...
	return (
		...
		>
			<div className="text-center">
				<div className="bg-primary-100 text-primary mb-6 inline-flex items-center space-x-2 rounded-full px-4 py-2 text-sm font-medium">
				...
				share.can ? (
					<div className="grid grid-cols-1 gap-6 @xl:grid-cols-2">
						...
						<Card className="group border-border/50 transition-all duration-300 hover:shadow-lg">
							<CardContent className="p-8">
								<div className="mb-6 flex items-center space-x-3">
									<div className="bg-primary-100 group-hover:bg-primary-200 flex aspect-square h-12 w-12 items-center justify-center rounded-xl transition-colors">
						...
						<Card className="group border-border/50 transition-all duration-300 hover:shadow-lg">
							<CardContent className="p-8">
								<div className="mb-6 flex items-center space-x-3">
									<div className="bg-accent-100 group-hover:bg-accent-200 flex aspect-square h-12 w-12 items-center justify-center rounded-xl transition-colors">
								...
								<CopyLinkButton
									size="lg"
									className="border-accent-300 bg-accent-100 text-accent-foresoft hover:bg-accent-200 w-full"
									variant="soft"
									url={share.url}
								/>
							</CardContent>
					...
					<div className="grid grid-cols-1 gap-4 @lg:grid-cols-2 @xl:grid-cols-2">
						...
						>
							<div className="flex items-center space-x-4">
								<div className="bg-info-100 group-hover:bg-info-200 flex h-12 w-12 items-center justify-center rounded-xl transition-colors">
									<Mail className="text-info-600 h-6 w-6" />
								</div>
								<div>
						...
						>
							<div className="flex items-center space-x-4">
								<div className="bg-success-100 group-hover:bg-success-200 flex h-12 w-12 items-center justify-center rounded-xl transition-colors">
									<MessageSquare className="text-success-600 h-6 w-6" />
								</div>
								<div>
						...
						{share.can ? null : (
							...
							>
								<div className="flex items-center space-x-3">
									<div className="bg-warning-100 group-hover:bg-warning-200 flex aspect-square h-12 w-12 items-center justify-center rounded-xl transition-colors">
										<Copy className="text-warning-600 h-6 w-6" />
									</div>
									<div>
										<h3 className="text-foreground text-lg font-semibold">
											Copy Link
			...
			<Card className="border-border/50 shadow-sm" data-testid="invite-qr-card">
				<CardContent className="flex flex-col items-center gap-6 p-8 @lg:flex-row @lg:items-center @lg:gap-8">
					...
					<div className="flex-1 space-y-3 text-center @lg:text-start">
						<div className="bg-accent-100 text-accent-foresoft inline-flex items-center space-x-2 rounded-full px-3 py-1 text-sm font-medium">
