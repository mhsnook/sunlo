...
export function ReviewBanner({
	...
	return (
		<div
			...
			data-key={focus.lang}
			className="hue-info bg-lum-2 bg-chroma-mlow border-lum-3 border-s-6-mhi-primary @container relative overflow-hidden rounded-lg border border-s-4 p-4 shadow-sm @md:p-5"
		>
