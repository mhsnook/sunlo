		...
		>
			<span
				className={cn(
					...
					selected ? 'bg-lum-7 text-lum-none' : ''
				)}
			>
					...
					<InfoDialog title="Daily Goal">
						...
						<div className="mx-2 space-y-3">
							<div className="bg-lum-1 flex items-start gap-3 rounded-2xl px-4 py-3">
								<Cat className="text-con-mid chroma-high mt-0.5 size-7 shrink-0" />
								<div>
							...
							<div className="bg-lum-1 flex items-start gap-3 rounded-2xl px-4 py-3">
								<IceCreamBowl className="text-con-mid chroma-high mt-0.5 size-7 shrink-0" />
								<div>
							...
							<div className="bg-lum-1 flex items-start gap-3 rounded-2xl px-4 py-3">
								<Rocket className="text-con-mid chroma-high mt-0.5 size-7 shrink-0" />
								<div>
