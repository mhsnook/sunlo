...
export function ScoreBreakdown({
	...
	return (
		<div className="text-con-mlow flex flex-col items-end gap-0 font-mono text-[10px] leading-tight tabular-nums">
			<span>
			...
			<span className="text-con-mhigh font-semibold">Σ {fmt2(combined)}</span>
		</div>
	)
}
