...
function SampleBlock({
	...
	return (
		<Card className="overflow-hidden">
			<div className="bg-primary-100 border-b px-4 py-2">
			...
			<CardContent className="space-y-5 p-5" style={baseStyle}>
				...
				<div className="bg-primary-100 rounded-2xl border p-4">
					<div className="flex items-start gap-3">
						<div className="bg-primary-300 text-primary-foreground flex size-10 shrink-0 items-center justify-center rounded-full text-sm">
							Y
						</div>
					...
					<blockquote className="bg-primary-200 mt-3 rounded-md border-s-4 px-4 py-3 italic">
