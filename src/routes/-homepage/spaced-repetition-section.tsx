					...
					<div className="text-center">
						<Link
							...
							className={cn(
								...
								'from-lum-5 from-chroma-high bg-gradient-to-r to-violet-500 font-semibold text-white/80 shadow-lg transition-all duration-300 hover:from-purple-600 hover:to-violet-600 hover:shadow-xl'
							)}
						>
