				...
				{showSearchTile && (
					<li data-key="__search__">
						<button
							...
							className="bg-lum-2 hover:bg-lum-2 hover:bg-chroma-mlow text-foresoft-primary flex w-full flex-col gap-1 rounded border border-dashed p-3 text-left text-sm"
						>
