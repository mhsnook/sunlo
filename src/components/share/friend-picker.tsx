...
function highlight(text: string, query: string): ReactNode {
	...
	return (
		<>
			{text.slice(0, i)}
			<mark className="bg-warning-200 text-warning-800 rounded-[3px] px-px">
...
function FriendRow({
	...
	return (
		<button
			...
			className={cn(
				'group hover:bg-neutral-50 flex w-full items-center gap-3 rounded-2xl px-2.5 py-2 text-start outline -outline-offset-1 outline-transparent transition-colors',
				selected && 'bg-primary-100 outline-primary-foresoft/40'
			)}
		>
			...
			<span className="flex shrink-0 flex-col items-end gap-1">
				{friend.status === 'pending' ? (
					<span className="bg-primary-200 text-primary-700 inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-bold tracking-wide uppercase">
...
export function SharePreviewChip({
	...
	return (
		<div className="bg-primary-50 border-primary-200 border-l-primary mx-3.5 flex items-center gap-2.5 rounded-lg border border-l-4 px-3 py-2.5">
		...
		return (
			<div className="flex flex-col">
				...
				<div className="text-muted-foreground px-6 py-9 text-center">
					<span className="bg-primary-200 text-primary-600 mb-3.5 inline-flex size-14 items-center justify-center rounded-full">
	...
	return (
		<div className="flex min-h-0 flex-1 flex-col">
			...
			<div className="bg-popover sticky top-0 z-5 border-b px-3.5 pt-3 pb-2.5">
				<div className="focus-within:bg-card focus-within:border-ring focus-within:ring-ring/25 flex items-center gap-2.5 rounded-2xl border bg-neutral-50 px-3 py-2 transition focus-within:ring-2">
						...
						<>
							...
							<div className="flex items-center gap-3 px-4.5 pt-3.5 pb-2">
								...
								<DialogPrimitive.Close
									...
									className="text-foreground ms-auto flex size-8 items-center justify-center rounded-md bg-neutral-200 transition-colors hover:bg-neutral-300"
								>
									<X className="size-4" />
								</DialogPrimitive.Close>
							</div>
