...
> = {
	request_commented: {
		...
		iconClass: 'text-lum-9 bg-lum-2',
	},
	comment_replied: {
		Icon: MessagesSquare,
		action: 'replied to your comment',
		iconClass: 'hue-info text-lum-9 bg-lum-2',
	},
	phrase_translated: {
		Icon: Languages,
		action: 'added a translation to your phrase',
		iconClass: 'hue-success text-lum-9 bg-lum-2',
	},
	phrase_referenced: {
		Icon: Link2,
		action: 'referenced your phrase as an answer',
		iconClass: 'hue-accent text-lum-9 bg-lum-2',
	},
	request_upvoted: {
		Icon: ThumbsUp,
		action: 'upvoted your request',
		iconClass: 'hue-warning text-lum-9 bg-lum-2',
	},
	change_suggested: {
		Icon: MessageSquareQuote,
		action: 'suggested a change to your content',
		iconClass: 'hue-neutral text-lum-9 bg-lum-2',
	},
}
