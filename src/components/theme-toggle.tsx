...
export function ThemeToggle() {
	...
	return (
		<Button
			...
			size="icon"
			onClick={toggle}
			className="border-con-low h-12 w-12 rounded-full border bg-white/10 transition-all duration-300 hover:bg-white/50 dark:border-white/10 dark:bg-black/10 dark:hover:bg-black/50"
		>
