...
function ReviewRemainingLink({
	...
	return (
		...
		>
			...
			<span className="text-primary-500 group-hover:text-primary-600 text-xs font-bold">
				{remaining} left
			</span>
		</Link>
	)
...
const calloutCard =
	'border-primary-200 bg-neutral-50 mx-2 mb-2 rounded-xl border p-3'
	...
	if (!sidebarOpen) {
		return (
			<Link
				...
				className="text-primary-500 mx-auto flex h-8 w-8 items-center justify-center rounded-lg bg-white transition-colors hover:bg-neutral-100"
			...
			<div className={calloutCard}>
				<div className="flex items-center gap-2">
					<div className={iconCircle}>
						<Rocket className="text-primary-500 h-4 w-4" />
					</div>
