...
export function OnboardingNudge() {
	...
	if (!open) {
		return (
			<Link
				...
				className="text-con-mid hover:bg-lum-up-1 mx-auto flex h-8 w-8 items-center justify-center rounded-lg bg-white transition-colors"
	...
	return (
		<div
			data-testid="onboarding-nudge"
			className="border-lum-[87] border-chroma-[6] bg-lum-[93] bg-chroma-[4] mx-2 mb-2 rounded-xl border p-3"
		>
			<div className="flex items-start gap-2">
				<div className="rounded-lg bg-white p-1.5">
					<Sparkles className="text-con-mid h-4 w-4" />
				</div>
