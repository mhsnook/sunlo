...
export function IntroCallout({
	...
	return (
		<div
			className={cn(
				'chroma-mlow bg-lum-2 border-lum-4 flex items-start gap-2 rounded border px-3 py-2 text-sm',
				className
			)}
		>
			...
			<div className="flex-1">
				...
				{onShowMore && (
					<>
						...
						<button
							onClick={onShowMore}
							className="text-con-mid chroma-high underline hover:no-underline"
						>
							{showMoreLabel}
						</button>
					</>
