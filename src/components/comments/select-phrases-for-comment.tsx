...
export function SelectPhrasesForComment({
	...
	const triggerButton = cardShape ? (
		<button
			...
			className="border-con-low text-con-mid hover:bg-lum-2 hover:text-con-mhigh hover:border-con-mlow hover:border-chroma-mlow flex h-30 min-w-50 basis-50 cursor-pointer items-center justify-center rounded-xl border-2 border-dashed transition-colors disabled:pointer-events-none disabled:opacity-50"
		>
