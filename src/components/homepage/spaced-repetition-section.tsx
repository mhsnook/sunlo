					...
					<div className="text-center">
						<Link
							...
							className={cn(
								...
								'from-primary transform bg-gradient-to-r to-violet-500 font-semibold shadow-lg transition-all duration-300 hover:scale-105 hover:from-purple-600 hover:to-violet-600 hover:shadow-xl'
							)}
						>
