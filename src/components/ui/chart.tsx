	...
	return (
		<ChartContext.Provider value={{ config }}>
			<div
				...
				ref={ref}
				className={cn(
					"[&_.recharts-cartesian-axis-tick_text]:fill-lum-7 [&_.recharts-cartesian-grid_line[stroke='#ccc']]:stroke-lum-2 [&_.recharts-curve.recharts-tooltip-cursor]:stroke-lum-3 [&_.recharts-polar-grid_[stroke='#ccc']]:stroke-lum-3 [&_.recharts-radial-bar-background-sector]:fill-lum-2 [&_.recharts-rectangle.recharts-tooltip-cursor]:fill-lum-2 [&_.recharts-reference-line_[stroke='#ccc']]:stroke-lum-3 flex aspect-video justify-center text-xs [&_.recharts-dot[stroke='#fff']]:stroke-transparent [&_.recharts-layer]:outline-none [&_.recharts-sector]:outline-none [&_.recharts-sector[stroke='#fff']]:stroke-transparent [&_.recharts-surface]:outline-none",
					className
				)}
				{...props}
			>
