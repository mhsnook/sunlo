...
const DropdownMenuItem = ({
	...
	const mergedClassName = cn(
		'focus:bg-lum-1 focus:bg-chroma-mlow relative flex cursor-default items-center gap-2 rounded-lg px-2 py-1.5 text-sm outline-hidden transition-colors select-none focus:ring data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
		inset && 'pl-8',
		className
	)
	return (
...
const DropdownMenuCheckboxItem = ({
	...
	<MenuPrimitive.CheckboxItem
		...
		className={cn(
			'focus:bg-lum-1 focus:bg-chroma-mlow relative flex cursor-default items-center rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden transition-colors select-none data-disabled:pointer-events-none data-disabled:opacity-50',
			className
		)}
		checked={checked}
		{...props}
