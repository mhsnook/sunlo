...
export function FancyMultiSelect({
	...
	return (
		...
		>
			<div className="group border-3-mlo-primary hover:border-primary ring-offset-background focus-within:ring-ring rounded-2xl border px-3 py-2 text-sm focus-within:ring-2 focus-within:ring-offset-2">
